...
> ```bash
> curl -fsSL https://raw.githubusercontent.com/mqiancheng/telegram-forward/refs/heads/test/telegram_forward_v2.sh -o telegram_forward_v2.sh && chmod +x telegram_forward_v2.sh && ./telegram_forward_v2.sh
> ```
